...
class Payment(models.Model):
    RECEIPT_TYPE_CHOICES = [
        ...
        ('Other', 'Other'),  # You can add more types if needed
    ]

    receipt_no = models.CharField(max_length=100)
    
    # Rename the field to 'student'
    ...
    receipt_type = models.CharField(max_length=100, choices=RECEIPT_TYPE_CHOICES)  # Use choices for receipt_type
